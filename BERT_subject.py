# BERT embeddings and KMeans for topic classification for subject
import os
import pandas as pd
...
sentence_embeddings = model.encode(filtered_df['processed_subject'].tolist())
...
# print(filtered_df[['subject', 'category', 'subcategory']].head(20).to_string(index=False))
